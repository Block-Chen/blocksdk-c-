...
namespace BlockSdk
{
    public class Bitcoin : Base
    {
        ...
        {
            return this.request("GET", "/btc/block").Result;
        }
        ...
        public string getBlock(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/btc/block/"+request["block"],request).Result;
        ...
        public string getMemPool(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/btc/mempool", request).Result;
        ...
        public string getAddressInfo(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/btc/block/" + request["address"], request).Result;
        ...
        {
            return this.request("GET", "/btc/address/" + request["address"]+"/balance", request).Result;
        ...
        public string listWallet(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/btc/wallet", request).Result;
        ...
        public string createWallet(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/btc/wallet", request).Result;
        }

        public string loadWallet(Dictionary<string, string> request)
        {
            return this.request("POST", "/btc/wallet" + request["wallet_id"]+"/load", request).Result;
        }

        public string unLoadWallet(Dictionary<string, string> request)
        {
            return this.request("POST", "/btc/wallet" + request["wallet_id"] + "/unload", request).Result;
        }
        ...
        public string listWalletAddress(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/btc/wallet/" + request["wallet_id"] + "/address").Result;
        }
        ...
        public string createWalletAddress(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/btc/wallet/" + request["wallet_id"] + "/address", request).Result;

        }

        public string getWalletBalance(Dictionary<string, string> request)
        {
            return this.request("GET", "/btc/wallet/"+request["wallet_id"]+"/balance").Result;
        }
        ...
        public string getWalletTransaction(Dictionary<string, string> request)
        {
            ...
            refineValues(request, false);
            return this.request("GET", "/btc/wallet/" + request["wallet_id"] + "/transaction", request).Result;
        ...
        public string sendToAddress(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/btc/wallet/" + request["wallet_id"] + "/sendtoaddress", request).Result;
        ...
        public string sendMany(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/btc/wallet/" + request["wallet_id"] + "/sendmany", request).Result;

        }

        public string sendTransaction(Dictionary<string, string> request)
        { 
             return this.request("POST", "/btc/transaction/", request).Result;
        }

        public string getTransaction(Dictionary<string, string> request)
        {
            return this.request("GET", "/btc/transaction/"+request["hash"]).Result;
        }

        public string getTransactionTracking(Dictionary<string, string> request)
        {
            return this.request("GET", "/btc/transaction/" + request["hash"]+ "/tracking").Result;
        }
